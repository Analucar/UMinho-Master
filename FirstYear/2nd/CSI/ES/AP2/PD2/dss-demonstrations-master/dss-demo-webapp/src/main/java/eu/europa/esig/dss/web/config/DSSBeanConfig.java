...
@Configuration
@ComponentScan(basePackages = { "eu.europa.esig.dss.web.job", "eu.europa.esig.dss.web.service", "eu.europa.esig.dss.web.repository" })
@Import({ PropertiesConfig.class, CXFConfig.class, PersistenceConfig.class, PersistenceUserConfig.class, ProxyConfiguration.class, WebSecurityConfig.class,
